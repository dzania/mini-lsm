...
impl MemTable {
    ...
    pub fn scan(&self, lower: Bound<&[u8]>, upper: Bound<&[u8]>) -> MemTableIterator {
        ...
        .build();
        // Because we are starting from empty item we need to consume it
        iter.next().expect("Memtable iterator should not fail");
        iter
    }
